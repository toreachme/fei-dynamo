...
<div class="container-fluid">
  ...
  <div class="row">
    <div class="col-md p-0">
      <img src="./assets/images/bottom-banner.png" class="img-fluid"/>
    </div>
  </div>
  <div class="row">
  ...
  <div class="row">
    <div class="pl-5 pb-5">
      ...
      <a href="#">
        <h4 class="font-weight-bold fc-link">Sell a Business  <span>&nbsp</span><i class="fas fa-arrow-right fs-20"></i></h4>
      </a>

      <a href="#">
        <h4 class="font-weight-bold fc-link">Buy a Business  <span>&nbsp</span><i class="fas fa-arrow-right fs-20"></i></h4>
      </a>
    </div>
  </div>
</div>
